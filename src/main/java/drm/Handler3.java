...
public class Handler3 implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    Gson gson = new GsonBuilder().setPrettyPrinting().create();
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent, Context context) {
        final String URL = "https://drmkit.hwcloudtest.cn:8082/drmproxy/v3/getLicense";
        final String AES = "GujM0OeYXMC2IDpVhVoQNK/CUpgOlwypDlICaJ+Uerk=";
        final String XAPPID = "102771135";
        final String XPORTALID = "TestForDeveloper";
