...
public class RequestDRM {
    static String AES = "QoHOSmSPUH1uGPr/lsxWb+1Mslu7cnJ9+tvPmNfEyJs=";

    static String path = "/drmproxy/v2/getLicense";
    static String xappid = "736430079244616618";
    ...
    public static final String IV = "0x1111222233334444";

    static byte[] key = doCipher(1, hexStringToByteArray(IV), Base64.getDecoder().decode(AES), hexStringToByteArray(IV));
    static String keyString = Base64.getEncoder().encodeToString(key);
    ...
    static String postbody = "{\"type\": \"licenseRequestExt\",\"payload\": \"\"," +
            ...
            keyString +
            "\",\"keyEncryptedIV\": \"" +
            Base64.getEncoder().encodeToString(hexStringToByteArray(IV)) +
    ...
    static String signKey = "NuNo4KniGniwrTZjs5fQcHeRCQsJ61H84UXUdaiLzIY=";
...
//                    .POST(HttpRequest.BodyPublishers.ofString("{}"))
    ...
    public static byte[] doCipher(int cipherMode, byte[] wordBytes, byte[] secretBytes, byte[] ivBytes) {
        // 定义密钥机制对象
        ...
        try {
            ...
            // 进行加解密操作
            outWordBytes = cipher.doFinal(wordBytes);
